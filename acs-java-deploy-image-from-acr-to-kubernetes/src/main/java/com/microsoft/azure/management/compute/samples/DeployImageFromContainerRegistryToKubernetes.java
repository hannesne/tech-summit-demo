...
public class DeployImageFromContainerRegistryToKubernetes {
    ...
    public static boolean runSample(Azure azure, String clientId, String secret) {
        ...
        String servicePrincipalClientId = "dd420db9-a06a-4753-a140-5e704615b146"; // replace with a real service principal client id
        String servicePrincipalSecret = "37d5ec77-5862-4dc4-9fb8-8a6285adf23a"; // and corresponding secret
        SSHShell shell = null;
        ...
        try {
            ...
            System.out.println("Service Principal ClientID: \n" + servicePrincipalClientId);
            System.out.println("Service Principal Secret: \n" + servicePrincipalSecret);
